...
import it.polimi.web.projectRIA.utils.*;
...
public class RegisterUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pwdrip = StringEscapeUtils.escapeJava(request.getParameter("pwdrip"));
		name = StringEscapeUtils.escapeJava(request.getParameter("name"));
		surname = StringEscapeUtils.escapeJava(request.getParameter("surname"));

		if (username == null || pwd == null || pwdrip == null || name == null || surname == null || username.isEmpty() || pwd.isEmpty() || pwd.isEmpty() || name.isEmpty() || surname.isEmpty() ) {
